...
import { AttendanceServiceError, confirmDailyExceptions } from "@/features/attendance/server/attendance-service";
...
export async function POST(req: Request) {
  ...
  try {
    ...
    return ok(await confirmDailyExceptions(access.scope, input.items));
  } catch (error) {
